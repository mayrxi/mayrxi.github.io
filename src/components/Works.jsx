    ...
    <div className='w-full flex'>
      ...
      className='mt-3 text-secondary text-[17px] max-w-3xl leading-[30px]'>
        I have crafted a diverse range of projects that demonstrate my technical proficiency and innovation. 
                  Notably, I have developed a MERN  application that showcases my expertise in building modern, full-stack
                  web applications. In addition, I have designed a Python GUI using the
